...
import ru.nukkit.multipass.command.group.GroupAddGroup;
import ru.nukkit.multipass.command.group.GroupCreate;
import ru.nukkit.multipass.command.group.GroupInfo;
import ru.nukkit.multipass.command.group.GroupRemove;
import ru.nukkit.multipass.command.group.GroupRemoveGroup;
import ru.nukkit.multipass.command.group.GroupRemovePerm;
import ru.nukkit.multipass.command.group.GroupSetGroup;
import ru.nukkit.multipass.command.group.GroupSetPerm;
import ru.nukkit.multipass.command.group.GroupSetPrefix;
import ru.nukkit.multipass.command.group.GroupSetSuffix;
import ru.nukkit.multipass.command.perm.PermCheck;
import ru.nukkit.multipass.command.perm.PermExport;
import ru.nukkit.multipass.command.perm.PermHelp;
import ru.nukkit.multipass.command.perm.PermImport;
...
import ru.nukkit.multipass.command.user.UserSetPerm;
import ru.nukkit.multipass.command.user.UserSetPrefix;
import ru.nukkit.multipass.command.user.UserSetSuffix;
